...
if __name__ == "__main__":
    ...
    np.savez_compressed("data/train_set_fingerprint_1024bits_radius2.npz", morgan=fingerprint)
    print("NumPy compressed file has been saved!")

    fingerprint = np.array([morgan_fp(i) for i in test_set])
    np.savez_compressed("data/test_set_fingerprint_1024bits_radius2.npz", morgan=fingerprint)
    print("NumPy compressed file has been saved!")
